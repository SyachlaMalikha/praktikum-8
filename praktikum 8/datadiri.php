...
<html>
    ...
    <body>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST"){
          ...
          if(empty($_POST["kode"]))
          {
              $error_kode= "Kode tidak boleh kosong";
          }
          else
          {
              $kode = cek_input ($_POST["kode"]);
              if(!is_numeric($kode))
              {
                  $error_kode = "Kode pos hanya boleh angka";
              }
          }
  ...
  <label for="kewarganegaraan" class="col-sm-2 col-form-label ">Kewarganegaraan</label>
    <div class="col-sm-10">
    <input type="radio" name="kewarganegaraan" value="Indonesia">Indonesia(WNI)</label> 
      <input type="radio" name="kewarganegaraan" value="Asing">Asing(WNA)</label> 
  ...
  if(isset($_POST['Submit'])) {
    ...
    $sql = "INSERT INTO data_pribadi (nik,nama,jk,nisn,tempat_lahir,tanggal_lahir,agama,khusus,alamat,rt,rw,dusun,desa,kecamatan,kode,tempat_tinggal,transpor,hp,telp,email,penerima_KPS,no_KPS,kewarganegaraan,negara) 
    VALUES ('$nik','$nama','$jk','$nisn',' $tempat_lahir','$tanggal_lahir','$agama','$khusus','$alamat','$rt','$rw','$dusun','$desa','$kecamatan','$kode','$tempat_tinggal','$transpor','$hp','$telp','$email','$penerima_KPS','$no_KPS','$kewarganegaraan','$negara')";
